                            ...
                            <div class="position-center">
                                <form role="form" action="{{URL::to('update-banner/'.$edit_pro->banner_id)}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="banner_cate" class="form-control input-lg m-bot15">
                                            @foreach ($cate_banner as $key => $cate)
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="{{URL::to('public/uploads/product/'.$edit_pro->banner_image)}}" alt="" height="100px" width="100px" style="margin-top: 10px">
                                </div>
                                <div class="form-group">
